...
var ASM_CONSTS = {
  1873184: ($0) => { _releaseCallback($0) },  
 1873209: ($0) => { return _callCallback($0).value ? 1 : 0; },  
 1873253: ($0) => { return _callCallback($0).value; },  
 1873289: ($0) => { return _callCallback($0).value; },  
 1873325: ($0) => { return _callCallback($0).value; },  
 1873361: ($0) => { _callCallback($0); }
};
