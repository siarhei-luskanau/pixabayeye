...
var ASM_CONSTS = {
  1873232: ($0) => { _releaseCallback($0) },  
 1873257: ($0) => { return _callCallback($0).value ? 1 : 0; },  
 1873301: ($0) => { return _callCallback($0).value; },  
 1873337: ($0) => { return _callCallback($0).value; },  
 1873373: ($0) => { return _callCallback($0).value; },  
 1873409: ($0) => { _callCallback($0); }
};
